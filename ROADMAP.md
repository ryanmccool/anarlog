...
- [x] Stop the attachment-transfer lifecycle in the desktop shell.
- [ ] Remove CloudSync runtime, sync-status host/component, credentials, database configuration, and attachment sync. In progress.
